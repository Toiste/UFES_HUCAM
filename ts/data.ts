...
export const answerOptions = [...trashGroups];

export function generateRandomRounds():RoundList{
    //Copies original list to manipulate
    const trashList:Array<Question> = [...trashListOrig]
    ...
    for (let r = 0; r < totalRounds; r++){
        ...
        for (let q = 0; q < questionsPerRound; q++){
            ...
            const currentTrash:Question =  {...trashList[randomIndex]};
